...
//this will send verification OTP to the user's email
...
export const sendResetOtp = async(req, res) => {
    ...
    try {
        ...
        const mailOption = {
            ...
            text: `Reset your password using this OTP. Your OTP is ${otp}. `
        };
...
export const resetPassword = async(req, res) => {
    ...
    if(!email || !otp || !newPassword){
        res.json({success: false, message: "Please fill up the required details"});
    }
